module.exports = {
    ...
    'USER': {
        ...
        no_image_upload: 'no image uploaded',
        profile_image_upload_success: 'profile image uploaded successfully',
        get_profile: 'successfully get the profile',
        update_profile: 'successfully update the profile',
        delete_profile: 'successfully delete the profile',
        get_all_users: 'successfully get all users',
        user_notfound:"user not found",
        personal_info_exists:"personalinformation already exist"
    },
    'GENERAL': {
    ...
    'HOLIDAY': {
        add_new_holiday: 'successfully add new holiday',
        already_exist_title: 'this holiday is already exist',
        get_all_holidays: 'successfully get all the holidays',
        not_found:'holiday data not found',
        update_holiday:'successfully update the holiday',
        delete_holiday:'successfully delete the holiday'
    }
}